        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DeliverAddress = table.Column<string>(type: "nvarchar(200)", nullable: false),
                    DeliverPhone = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    DeliverUser = table.Column<string>(type: "nvarchar(150)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Role",
                columns: new[] { "Id", "Created_Date", "Descriptions", "Name", "Updated_Date" },
                values: new object[,]
                {
                    { 0, new DateTime(2023, 11, 26, 0, 10, 21, 533, DateTimeKind.Local).AddTicks(6879), null, "Admin", null },
                    { 1, new DateTime(2023, 11, 26, 0, 10, 21, 533, DateTimeKind.Local).AddTicks(6896), null, "User", null }
                });
